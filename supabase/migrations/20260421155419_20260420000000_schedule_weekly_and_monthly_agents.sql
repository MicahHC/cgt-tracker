/*
  # Scheduler for Agent Workflow

  Registers pg_cron jobs for weekly signal-detection/discovery and monthly re-evaluation.
  Requires app.functions_base_url and app.service_role_key GUCs (set separately).
*/
